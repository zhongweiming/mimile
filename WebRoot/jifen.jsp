...
<html>
  ...
  <div class="header">
		...
		<div class="nav">
                ...
                <li id="sh"><a href="jifen.jsp"><input type="text" value="积分专区" /></a></li>
	...
	<div class="content1">
		<div class="c-left">
			<div class="fenlei">
				<ul>
                	<li>商品分类</li>
                    <li><a href="jifenfushi.jsp">服饰</a></li>
                    <li><a href="jifenxiebao.jsp">鞋包</a></li>
                    <li><a href="jifenmeishi.jsp">美食</a></li>
                    <li><a href="jifenjiadian.jsp">家电</a></li>
            	</ul>
            </div>
		</div>
