...
<head>
<title>特卖服饰</title>
<link href="css/fenlei.css" type="text/css" rel="stylesheet" />
...
<body>
	<div id="top">
		...
		<ul class="menu2">
			...
			<li><a href="userInfo" class="top_link">我的米米乐</a></li>
				...
				<dl class="dl1">
					<dt>
						<a href="goods_info.jsp"><img
							src="images/a23dd5b2b7fc72067303f94df54d69e8.jpg"></img></a>
					</dt>
					<dd>精品羽绒服</dd>
				</dl>
				<dl class="dl1">
