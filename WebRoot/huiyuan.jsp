	...
	<div class="header">
		<div class="nav">
			<ul>
				...
				<li id="sh"><a href="#"><input type="text" value="会员专区" style="color:black;"></a></li>
	...
	<div class="content1">
		<div class="c-left">
			<div class="fenlei">
				<ul>
					<li>商品分类</li>
					<li><a href="huiyuanfushi.jsp">服饰</a></li>
					<li><a href="huiyuanxiebao.jsp">鞋包</a></li>
					<li><a href="huiyuanmeishi.jsp">美食</a></li>
					<li><a href="huiyuanjiadian.jsp">家电</a></li>
				</ul>
			</div>
		</div>
		<div class="line1">
		...
		<div class="shangpin">
			<div class="main1">
				<dl class="dl1">
					<dt>
						<a href="goods_info.jsp"><img src=""></img></a>
					</dt>
					<dd></dd>
				</dl>
				<dl class="dl1">
