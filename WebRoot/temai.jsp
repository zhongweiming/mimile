...
<html>
  ...
  <div class="header">
		<div class="nav">
               ...
               <li id="sh"><a href="temai.jsp"><input type="text" value="特卖会场" /></a></li>
	...
	<div class="content1">
		<div class="c-left">
			<div class="fenlei">
				<ul>
                	<li>商品分类</li>
                    <li><a href="tejiafushi.jsp">服饰</a></li>
                    <li><a href="tejiaxiebao.jsp">鞋包</a></li>
                    <li><a href="tejiameishi.jsp">美食</a></li>
                    <li><a href="tejiajiadian.jsp">家电</a></li>
            	</ul>
            </div>
		</div>
